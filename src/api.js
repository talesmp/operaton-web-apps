...
export const get_task_list = (sort_key, sort_order) => {
...
export const get_task = (task_id) => {
  return fetch(`${base_url}/task/${task_id}`, { headers: headers })
    .then((response) => response.json())
}

export const get_process_definition_list = (ids) => {
  return fetch(base_url + '/process-definition?processDefinitionIdIn=' + ids, { headers: headers })
    .then((response) => response.json())
}

export const get_generated_form = (task_id) => {
  return fetch(`${base_url}/task/${task_id}/rendered-form`, { headers: headers })
    .then((response) => response.text())
}

export const claim_task = (task_id, state) => assign_task(true, task_id, state)

export const unclaim_task = (task_id, state) => assign_task(false, task_id, state)
